...
public class VendasEmMemoria implements VendasFachada {
    ...
    public VendasEmMemoria() {
        ...
        produtos.add((ProdutoComponent) caneta);
        produtos.add((ProdutoComponent) borracha);
        produtos.add((ProdutoComponent) caderno);

        KitProduto kitEstudante = new KitProduto(4, "Kit Estudante");
        kitEstudante.adicionarItem(caneta);
        kitEstudante.adicionarItem(borracha);
        kitEstudante.adicionarItem(caderno);

        produtos.add(kitEstudante);
    }
